...
(function (pages) {
    ...
    pages.write = write;
    ;
    function writeDB(pagesCollection) {
        return __awaiter(this, void 0, void 0, function* () {
            const allPages = yield this.get();
            const insertPages = [];
            for (const region of allPages) {
                for (const web of region.webs) {
                    try {
                        const details = yield getDetails(web.url);
                        insertPages.push(Object.assign(Object.assign(Object.assign({}, web), details), { region: region.region }));
                    }
                    catch (error) {
    ...
    function getDetails(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const info = yield page.evaluate(() => {
                ...
                const descItem = document.querySelector('meta[name=description]');
                const description = descItem ? descItem.content : '';
                const titleItem = document.querySelector('title');
                const title = titleItem ? titleItem.text.trim() : '';
